...
public class ReviewTestSamples {
    ...
    public static Review getReviewSample1() {
        return new Review().id(1L).rating(1).title("title1").helpfulCount(1).notHelpfulCount(1);
    }

    public static Review getReviewSample2() {
        return new Review().id(2L).rating(2).title("title2").helpfulCount(2).notHelpfulCount(2);
    }
    ...
    public static Review getReviewRandomSampleGenerator() {
        return new Review()
            ...
            .notHelpfulCount(intCount.incrementAndGet());
    }
}
