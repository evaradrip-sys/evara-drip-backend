...
class CategoryCriteriaTest {
    ...
    private static void setAllFilters(CategoryCriteria categoryCriteria) {
        ...
        categoryCriteria.imageUrl();
        categoryCriteria.href();
        categoryCriteria.isFeatured();
        categoryCriteria.displayOrder();
        categoryCriteria.productsId();
        categoryCriteria.subcategoriesId();
        categoryCriteria.featuredProductsId();
    ...
    private static Condition<CategoryCriteria> criteriaFiltersAre(Function<Object, Boolean> condition) {
        return new Condition<>(
            criteria ->
                ...
                condition.apply(criteria.getHref()) &&
                condition.apply(criteria.getIsFeatured()) &&
                condition.apply(criteria.getDisplayOrder()) &&
                condition.apply(criteria.getProductsId()) &&
                condition.apply(criteria.getSubcategoriesId()) &&
                condition.apply(criteria.getFeaturedProductsId()) &&
    ...
    private static Condition<CategoryCriteria> copyFiltersAre(CategoryCriteria copy, BiFunction<Object, Object, Boolean> condition) {
        return new Condition<>(
            criteria ->
                ...
                condition.apply(criteria.getHref(), copy.getHref()) &&
                ...
                condition.apply(criteria.getSubcategoriesId(), copy.getSubcategoriesId()) &&
                condition.apply(criteria.getFeaturedProductsId(), copy.getFeaturedProductsId()) &&
