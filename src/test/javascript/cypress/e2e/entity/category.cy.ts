...
describe('Category e2e test', () => {
  ...
  const categorySample = { name: 'pack luck around', href: '/vweiyj' };
  ...
  describe('new Category page', () => {
    ...
    it('should create an instance of Category', () => {
      ...
      cy.get(`[data-cy="imageUrl"]`).type('mixed ack dulcimer');
      cy.get(`[data-cy="imageUrl"]`).should('have.value', 'mixed ack dulcimer');

      cy.get(`[data-cy="href"]`).type('/s');
      cy.get(`[data-cy="href"]`).should('have.value', '/s');
      ...
      cy.get(`[data-cy="displayOrder"]`).type('31409');
      cy.get(`[data-cy="displayOrder"]`).should('have.value', '31409');
