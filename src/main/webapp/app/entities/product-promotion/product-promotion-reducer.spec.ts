...
import reducer, {
  ...
  reset,
  updateEntity,
} from './product-promotion.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PRODUCTPROMOTION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PRODUCTPROMOTION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PRODUCTPROMOTION actions', async () => {
      const arg = { id: 14239 };
    ...
    it('dispatches UPDATE_PRODUCTPROMOTION actions', async () => {
      const arg = { id: 14239 };
    ...
    it('dispatches PARTIAL_UPDATE_PRODUCTPROMOTION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PRODUCTPROMOTION actions', async () => {
      const arg = 42666;
