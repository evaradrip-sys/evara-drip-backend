  ...
  return (
    <div>
      <h2 id="product-image-heading" data-cy="ProductImageHeading">
        <Translate contentKey="evaradripApp.productImage.home.title">Product Images</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="evaradripApp.productImage.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/product-image/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="evaradripApp.productImage.home.createLabel">Create new Product Image</Translate>
          </Link>
        </div>
      </h2>
        ...
        {productImageList && productImageList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="evaradripApp.productImage.id">ID</Translate>{' '}
                ...
                <th>
                  <Translate contentKey="evaradripApp.productImage.product">Product</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {productImageList.map((productImage, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{productImage.displayOrder}</td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="evaradripApp.productImage.home.notFound">No Product Images found</Translate>
            </div>
          )
        )}
      </div>
