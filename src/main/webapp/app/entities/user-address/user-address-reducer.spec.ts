...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USERADDRESS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_USERADDRESS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_USERADDRESS actions', async () => {
      const arg = { id: 23614 };
    ...
    it('dispatches UPDATE_USERADDRESS actions', async () => {
      const arg = { id: 23614 };
    ...
    it('dispatches PARTIAL_UPDATE_USERADDRESS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_USERADDRESS actions', async () => {
      const arg = 42666;
