...
import { deleteEntity, getEntity } from './wishlist.reducer';
...
export const WishlistDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate(`/wishlist${pageLocation.search}`);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="evaradripApp.wishlist.delete.question">
        <Translate contentKey="evaradripApp.wishlist.delete.question" interpolate={{ id: wishlistEntity.id }}>
