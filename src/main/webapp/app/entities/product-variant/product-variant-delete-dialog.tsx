...
export const ProductVariantDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="evaradripApp.productVariant.delete.question">
        <Translate contentKey="evaradripApp.productVariant.delete.question" interpolate={{ id: productVariantEntity.id }}>
