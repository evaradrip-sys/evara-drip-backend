...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PRODUCTVARIANT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PRODUCTVARIANT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PRODUCTVARIANT actions', async () => {
      const arg = { id: 30935 };
    ...
    it('dispatches UPDATE_PRODUCTVARIANT actions', async () => {
      const arg = { id: 30935 };
    ...
    it('dispatches PARTIAL_UPDATE_PRODUCTVARIANT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PRODUCTVARIANT actions', async () => {
      const arg = 42666;
