...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './shipping.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SHIPPING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SHIPPING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SHIPPING actions', async () => {
      const arg = { id: 12088 };
    ...
    it('dispatches UPDATE_SHIPPING actions', async () => {
      const arg = { id: 12088 };
    ...
    it('dispatches PARTIAL_UPDATE_SHIPPING actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SHIPPING actions', async () => {
      const arg = 42666;
