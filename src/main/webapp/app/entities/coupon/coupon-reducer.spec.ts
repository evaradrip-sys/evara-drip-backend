...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './coupon.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COUPON_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_COUPON actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_COUPON actions', async () => {
      const arg = { id: 29129 };
    ...
    it('dispatches UPDATE_COUPON actions', async () => {
      const arg = { id: 29129 };
    ...
    it('dispatches PARTIAL_UPDATE_COUPON actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_COUPON actions', async () => {
      const arg = 42666;
