...
export const NotificationDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="evaradripApp.notification.delete.question">
        <Translate contentKey="evaradripApp.notification.delete.question" interpolate={{ id: notificationEntity.id }}>
