...
export const UserProfileDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="evaradripApp.userProfile.delete.question">
        <Translate contentKey="evaradripApp.userProfile.delete.question" interpolate={{ id: userProfileEntity.id }}>
